...
//                 console.log("debuggfrommformattedresponseeee111111111111111111111111111",response.data);
//                 break;
//             case "refactor":
...
//             });
//             console.log("gesolutiondebughittttt111111111111111111111111111",response);
...
//           const response = await this.processWithAI(command, text, isUserPrompt);
...
//   private async processWithAI(command: string, content: string, isUserPrompt: boolean = false): Promise<string> {
//     try {
//       // Use cached response if same command and content
//       if (!isUserPrompt && this.lastResponse 
//           && this.lastCommand === command 
//           && this.lastContent === content) {
...
// //   async getSolution(errorText: string): Promise<any> {
// //     const response = await this.processWithAI('debug', errorText);
    
// //     return {
// //       suggestions: this.lastResponse?.suggestions || [],
// //       code_snippets: this.lastResponse?.code_snippets || [],
// //       analysis: this.lastResponse?.analysis || "No detailed analysis available"
// //     };
// //   }
